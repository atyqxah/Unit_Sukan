				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div class="row">
								<div class="col-lg-12">
									<form role="form" method="POST" action="updateSupplierController">
										...
										<div class="form-group">
											<label>Supplier ID</label> <input class="form-control"
												name='supid' type='text' value="<%=supid%>" readonly>
										</div>

										<div class="form-group">
											<label>Supplier Name</label> <input class="form-control"
												name='supname' type='text' value="<%=s.getSupname()%>">
										</div>
										<div class="form-group">
											<label>Supplier Email</label> <input class="form-control"
												name='supemail' type='text' value="<%=s.getSupemail()%>">
										</div>
										<div class="form-group">
											<label>Supplier Contact Number</label> <input
												class="form-control" type='number'
												name='supcontact' value="<%=s.getSupcontact()%>">
										</div>
										<div class="form-group">
											<label>Company Address</label> <input
												class="form-control" type='text' name='supaddress'
												value="<%=s.getSupaddress()%>">
										</div>
										<input class="btn btn-primary btn-lg btn-block" type="submit" value="Update Supplier" onclick="return confirm('Update this supplier?')">
								</div>
